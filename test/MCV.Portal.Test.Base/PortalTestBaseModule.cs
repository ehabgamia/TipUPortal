...
using MCV.Portal.Test.Base.DependencyInjection;
using MCV.Portal.Test.Base.UiCustomization;
using MCV.Portal.Test.Base.Url;
using MCV.Portal.Test.Base.Web;
using MCV.Portal.UiCustomization;
using MCV.Portal.Url;
using NSubstitute;

namespace MCV.Portal.Test.Base
{
    [DependsOn(
