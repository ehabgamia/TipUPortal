...
using MCV.Portal.Schemas;
using MCV.Portal.Web.Chat.SignalR;
using MCV.Portal.Web.Common;
using MCV.Portal.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using MCV.Portal.Web.IdentityServer;
using MCV.Portal.Web.Swagger;
using Stripe;
...
using MCV.Portal.Web.HealthCheck;
using Owl.reCAPTCHA;
// TODO@NET5: Fix this: This package is not upgraded to .NET 5 yet.
// using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;

namespace MCV.Portal.Web.Startup
{
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                app.UseSwaggerUI(options =>
                {
                    ...
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("MCV.Portal.Web.wwwroot.swagger.ui.index.html");
