...
using MCV.Portal.ApiClient;
using MCV.Portal.Core.Dependency;
using MCV.Portal.Localization.Resources;
using MCV.Portal.Services.Account;
using MCV.Portal.Services.Navigation;
using MCV.Portal.Services.Storage;
...
namespace MCV.Portal
{
    public partial class App : Application
    {
        ...
        protected override async void OnStart()
        {
            ...
            //SubjectView subj = new SubjectView();
